    ...
    <>
      ...
      <div className={`${styles.sidebar} ${collapsed ? styles.sidebarCollapsed : ""}`}>
        ...
        <div className={styles.menuScroll}>
          <div className={styles.navItem} onClick={() => navigate("/hr/dashboard")}>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 21V7L10 0L20 7V21H12.5V12.8333H7.5V21H0Z" fill="currentColor" />
            </svg>
            <span className={getActive("/hr/dashboard") ? styles.navTextActive : styles.navText}>Home</span>
          </div>

          <div className={styles.navItem} onClick={() => navigate("/hr/employees")}>
            <Users size={20} />
            <span className={getActive("/hr/employees") ? styles.navTextActive : styles.navText}>People</span>
          </div>

          <div className={styles.navItem} onClick={() => navigate("/hr/attendance")}>
            ...
            <span className={getActive("/hr/attendance") ? styles.navTextActive : styles.navText}>Hiring</span>
          </div>

          <div className={styles.navItem} onClick={() => navigate("/hr/payroll")}>
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className={getActive("/hr/payroll") ? styles.navTextActive : styles.navText}>Onboarding</span>
          </div>

          <div className={styles.navItem} onClick={() => navigate("/hr/payroll-reports")}>
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className={getActive("/hr/payroll-reports") ? styles.navTextActive : styles.navText}>Documents and Payroll</span>
          </div>
        </div>
      </div>
