...
const Rolepage = () => {
  ...
  const fetchRoles = async () => {
    try {
      ...
      const res = await axios.get(
        `https://atlasbackend-q7bl.onrender.com/api/v1/admin/getroles`
      );
  ...
  const handlecreate = async () => {
    try {
      setSubmitting(true);
      await axios.post(
        `https://atlasbackend-q7bl.onrender.com/api/v1/admin/createrole`,
  ...
  const handleupdate = async () => {
    try {
      setSubmitting(true);
      await axios.put(
        `https://atlasbackend-q7bl.onrender.com/api/v1/admin/updaterole`,
        {
          roleid,
          rolename: eroleName,
          details: edetails,
  ...
  const handledelete =async(id)=>{
    ...
    try {
      const response = await axios.delete(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/deleterole/${id}`,
      {withCredentials:true}
      )
