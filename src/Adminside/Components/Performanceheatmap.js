...
const PerformanceHeatmap = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      const res1 = await axios.get(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/getreports`);
      const res2 = await axios.get(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/getalluser`);
