    ...
    async function fetchAll() {
      try {
        ...
        const [tRes, uRes, pRes] = await Promise.all([
          axios.get(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/getalltask`, { withCredentials: true }),
          axios.get(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/getalluser`, { withCredentials: true }),
          axios.get(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/getallproject`, { withCredentials: true }),
        ]);
...
const pageItems = useMemo(() => {
  ...
  const handleDelete = async (task) => {
    ...
    try {
      ...
      await axios.delete(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/deletetask/${task._id}`, { withCredentials: true });
    ...
    <div className={styles.editModal}>
      ...
      <button
        ...
        onClick={async () => {
          try {
            await axios.put(
              `https://atlasbackend-q7bl.onrender.com/api/v1/admin/updatetask/${selectedTask._id}`,
              form,
