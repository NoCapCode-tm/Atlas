...
const [showModal, setShowModal] = useState(false);
    ...
    const fetchEmployee = async () => {
      try {
        const res = await axios.get(
          `https://atlasbackend-q7bl.onrender.com/api/v1/admin/getuserdetails/${id}`,
  ...
  //           `https://atlasbackend-q7bl.onrender.com/api/v1/manager/getaisummary`,
  //           { id: employee._id },
  //           { withCredentials: true }
  //         );
    ...
    const fetchProjects = async () => {
      ...
      try {
        const response = await axios.get(
          "https://atlasbackend-q7bl.onrender.com/api/v1/admin/getallproject",
          { withCredentials: true }
        );
...
const updateTaskStatus = async (taskId, newStatus) => {
  try {
    await axios.put(
      `https://atlasbackend-q7bl.onrender.com/api/v1/employee/updatetask/${taskId}`,
      { status: newStatus },
      { withCredentials: true }
    );
