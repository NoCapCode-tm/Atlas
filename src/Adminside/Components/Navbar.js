...
function Navbar() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const response = await axios.get("https://b-atlas-ncc.onrender.com/api/v1/admin/getuser", { withCredentials: true })
  ...
  const handlelogout = async () => {
    try {
      const response = await axios.get("https://b-atlas-ncc.onrender.com/api/v1/admin/logout", { withCredentials: true })
