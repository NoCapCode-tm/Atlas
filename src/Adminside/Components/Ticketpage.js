...
const [creating, setCreating] = useState(false);
  ...
  try {
    const response = await axios.get(
      `https://atlasbackend-q7bl.onrender.com/api/v1/admin/gettickets`
    );
...
useEffect(() => {
  ...
  const handlestatus = async(status)=>{
    ...
    useEffect(()=>{
        (async()=>{
           const response = await axios.get(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/getroles`)
           console.log(response)
          ...
          onClick={async () => {
            try {
              const response = await axios.post(
                `https://atlasbackend-q7bl.onrender.com/api/v1/admin/assign`,
