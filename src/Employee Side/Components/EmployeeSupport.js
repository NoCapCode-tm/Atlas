...
useEffect(() => {
  ...
  const loadDashboard = async () => {
    ...
    try {
      const [
        ...
        axios.get("https://atlasbackend-q7bl.onrender.com/api/v1/admin/gettickets"),
        axios.get("https://atlasbackend-q7bl.onrender.com/api/v1/admin/getalluser")
      ]);
  ...
  try {
    ...
    await axios.post(
      `https://atlasbackend-q7bl.onrender.com/api/v1/admin/createticket`,
      {
        title: form.title,
...
const handledetails = async(id) =>{
      const response = await axios.post(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/ticketdetail`,{
            id:id
           },{withCredentials:true})
...
const sendMessage =async() =>{
        try {
            const response = await axios.post(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/comment`,{
                comment:comment,
                id:ticket._id
            },{withCredentials:true})
     ...
     const handlestatus = async(status)=>{
        ...
        try {
            const response = await axios.post(`https://atlasbackend-q7bl.onrender.com/api/v1/admin/updatestatus`,{
                id:ticket._id,
                status:status
            },{withCredentials:true})
            console.log(response)
