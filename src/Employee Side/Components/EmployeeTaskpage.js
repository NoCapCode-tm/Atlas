...
export default function EmployeeTaskpage() {
  ...
  const handleFileSelect = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "https://atlasbackend-q7bl.onrender.com/api/v1/employee/task/upload-attachment",
  ...
  const handlecomment = async () => {
    try {
      await axios.post("https://atlasbackend-q7bl.onrender.com/api/v1/employee/commentsend",
  ...
  const handlecomplete = async () => {
    try {
      await axios.post("https://atlasbackend-q7bl.onrender.com/api/v1/employee/complete-task",
  ...
  const handlereview = async () => {
    try {
      await axios.post("https://atlasbackend-q7bl.onrender.com/api/v1/employee/review-task",
        { taskid: selectedTask._id, userid: user._id }
      );
          ...
          {boardColumns.map((col) => (
            <div
              ...
              onDrop={async () => {
                ...
                try {
                  await axios.put(
                    `https://atlasbackend-q7bl.onrender.com/api/v1/employee/updatetask/${draggedTask._id}`,
                    { status: col.key },
                    { withCredentials: true }
                  );
